...
if [ $STATUS -ne 0 ]; then
    echo "${RED}Error:${DEFAULT} Multidev <${YELLOW}${ENVIRONMENT}${DEFAULT}> doesn't appear to exist on the ${PANTHEON_SITE_ID} pantheon account. Check your multidev name and try again."
